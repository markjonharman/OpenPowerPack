...
**Note I have only just begun work on this the week of Christmas 2025. I am uploading schematic Rev. D0 and making this public so that hopefully people start seeing it and joining Discord. Once I am done with the design and have PCB returned things will get a lot more interesting. Rev D0 implies it is not complete so there are likely errors. Any feedback on features people would like to see that don't seem supported, make an issue or chat about it in Discord!**
